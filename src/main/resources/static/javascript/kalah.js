...
app.controller('LoginController', function LoginController($scope) {
        ...
        $scope.login.doLogin = function () {
            ...
            var loginRequest = new Request(LOGIN, $scope.login.username);
            ...
            loginRequest.onTransportFailure = function (errorMsg, request) {
                ...
                $scope.main.header = 'WebSocket Kalah Game. Default transport is WebSocket, fallback is ' + request.fallbackTransport;
            };
                    ...
                    $scope.$apply(function () {
                        if (message.event) {
                            switch (message.event) {
                                case 'LOGIN' :
                                {
                                    $scope.main.games = message.object;
                                    break;
                                }
                                case 'USERS_UPDATE':
                                {
                                    $scope.main.users = message.object;
                                    break;
                                }
                                case 'GAMES_UPDATE':
                                {
